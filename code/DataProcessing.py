...
train_file1 = r'C:\Users\Johnson\Desktop\dataset\dataset\train_index_return.csv'  # 35个基准
train_file2 = r'C:\Users\Johnson\Desktop\dataset\dataset\train_fund_return.csv'
train_file3 = r'C:\Users\Johnson\Desktop\dataset\dataset\train_fund_benchmark_return.csv'
...
def data_processing(file1, file2, file3, file4):
    data1 = pd.read_csv(file1, encoding='gbk',header=None)
